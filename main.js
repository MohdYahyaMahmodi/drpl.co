    ...
    function updatePeerList() {
      ...
      if (peerIds.length === 0) {
        ...
        peerIds.forEach((pid) => {
          ...
          // Create a left-aligned button
          const btn = document.createElement('button');
          btn.className = 'peer-button w-full py-3 bg-[#333533] text-white rounded-lg hover:bg-[#242423] transition-colors';
          ...
          // (Optional) If you want a click action:
